...
** All Lua API symbols are always exported so that debuggers and external
** implementors (e.g. DAP adapters) can resolve them from the host DLL/SO.
** On Windows this uses __declspec(dllexport/dllimport); on Linux/macOS the
** GCC/Clang visibility attribute makes symbols visible in the shared library.
*/
#if defined(_WIN32)
